...
Development
---------------------
The Phore repo's [root README](https://github.com/cryptotronxyz/Phore/blob/master/README.md) contains relevant information on the development process and automated testing.
